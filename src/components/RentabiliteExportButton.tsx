...
// Export de la vue Opérationnelle (seuils de poses) de l'onglet Rentabilité
// — pendant du GeodisExportButton pour la vue Financière, même bouton
// labellé "Exporter" plutôt qu'une icône seule dans un menu générique.
export function RentabiliteExportButton({
  columns,
  rows,
  filename,
  title,
